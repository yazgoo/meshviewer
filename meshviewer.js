...
function init(settings) {
    ...
    var frontLight = new THREE.DirectionalLight( 0xeeddcc );
    frontLight.position.set( 10, 10, 5 ).normalize();
    scene.add( frontLight );

    var backLight = new THREE.DirectionalLight( 0xeeddcc );
    backLight.position.set( -10, -10, 5 ).normalize();
    scene.add( backLight );

    var rightLight = new THREE.DirectionalLight( 0xeeddcc );
    rightLight.position.set( 5, 10, 10 ).normalize();
    scene.add( rightLight );

    var leftLight = new THREE.DirectionalLight( 0xeeddcc );
    leftLight.position.set( 5, -10, -10 ).normalize();
    scene.add( leftLight );
